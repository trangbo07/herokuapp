-- Healthcare Management System - Sample Data (Plain Text Password)
-- This file contains sample data for testing with plain text passwords

-- ====================================================================
-- Sample Account Patients (Plain text passwords)
INSERT INTO AccountPatient (username, password, email, img, status) VALUES
('patient1', 'password123', 'patient1@example.com', 'default.jpg', 'Enable'),
('patient2', 'password123', 'patient2@example.com', 'default.jpg', 'Enable'),
('patient3', 'password123', 'patient3@example.com', 'default.jpg', 'Enable');
...
-- ====================================================================
-- Sample Account Staff (Plain text passwords)
INSERT INTO AccountStaff (username, password, role, email, img, status) VALUES
('doctor1', 'password123', 'Doctor', 'doctor1@hospital.com', 'doctor1.jpg', 'Enable'),
('doctor2', 'password123', 'Doctor', 'doctor2@hospital.com', 'doctor2.jpg', 'Enable'),
('nurse1', 'password123', 'Nurse', 'nurse1@hospital.com', 'nurse1.jpg', 'Enable'),
('reception1', 'password123', 'Receptionist', 'reception1@hospital.com', 'reception1.jpg', 'Enable'),
('admin1', 'password123', 'AdminSys', 'admin1@hospital.com', 'admin1.jpg', 'Enable');
...
-- ====================================================================
-- Sample Account Pharmacist (Plain text password)
INSERT INTO AccountPharmacist (username, password, email, status, img) VALUES
('pharmacist1', 'password123', 'pharmacist1@hospital.com', 'Enable', 'pharmacist1.jpg');
...
-- ====================================================================
-- DEFAULT PASSWORDS (PLAIN TEXT): "password123"
-- 
-- Test Accounts:
-- Patient: patient1@example.com / password123
-- Doctor: doctor1@hospital.com / password123  
-- Nurse: nurse1@hospital.com / password123
-- Pharmacist: pharmacist1@hospital.com / password123
-- Admin: admin1@hospital.com / password123

SELECT 'Sample data with plain text passwords inserted successfully!' as message; 